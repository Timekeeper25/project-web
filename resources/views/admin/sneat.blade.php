...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">TeaShoes</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item open">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-home-circle"></i>
        <div data-i18n="Dashboards">Tampilkan Data</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
    ...
    <li class="menu-item open">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-home-circle"></i>
        <div data-i18n="Dashboards">Tambah Data</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
        ...
        <li class="menu-item">
          <a href="{{ route('transactionDetail.create') }}" class="menu-link">
            <div>Data Transaksi</div>
          </a>
        </li>
      </ul>
